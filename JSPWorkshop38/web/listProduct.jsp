...
function update(n){
 	 event.preventDefault();  	
	var m= document.querySelector("#quantity"+n);// id=quantity제품id로 element선택 ex) qunatityP1선택 
	var quantity= m.value;//// id=quantity제품id로 element선택 ex) qunatityP1의 value 값 사용 
