...
<script type="text/javascript">
	function chk(n) {//전체선택 check 박스 처리
	...
	function delAll() {
		document.querySelector("#delForm").action='deleteAllProduct.jsp';//폼데이터를 전부  deleteAllProduct.jsp로 전송
		document.querySelector("#delForm").submit; //서브밋 이벤트 발생 
	}

</script>
</head>
<body>
<form id="delForm"><!-- action은 script에서 지정  -->
<table border="1">
  <tr>
